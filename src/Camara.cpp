...
Camara::Camara(){
    ...
    Mundo::Instance()->camRes->x = (int)Juego::Instance()->windowWidth;
    Mundo::Instance()->camRes->y = (int)Juego::Instance()->windowHeight;
   ...
   ifstream fin;
   fin.open("resources/common/HUDspritesheet.xml"); // abrir el xml que se va a leer
...
//             cout << endl;
   ...
   font.loadFromFile("resources/fonts/MyriadPro Regular.ttf");

     fontpixelated.loadFromFile("resources/fonts/MyriadPro Regular.ttf");
     ...
     hudVotosValue.setFillColor(sf::Color::White);
     ...
     contadorValue.setFillColor(sf::Color::Black);


    //Cargo la imagen donde reside la textura del sprite del HUD
    if (!texturaHUD.loadFromFile("resources/common/HUDspritesheet.png"))
    {
...
//           std::cout<<"posicionhud "<<hudVotos.getPosition().x;
            ...
            EMenu::Instance(Juego::Instance())->moverMenu(kVel);
            //ECargando::Instance(Juego::Instance())->moverCartel(kVel);
        }
...
void Camara::setCameraPos(int x){

camara->setCenter(sf::Vector2f(x,300));

}

void Camara::setCameraOrigin(){
